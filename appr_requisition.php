                            ...
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <?php  if ($_SESSION['access_permission'] == 'purchaser' || $_SESSION['access_permission'] == 'Store Admin' || $_SESSION['access_permission'] == 'log admin' ) {?>
                                       <h1 class="m-0 text-dark">Delivered Requisition</h1>
                                   <?php }else{?>
                                                                ...
                                                                <div class="card-body p-0">
                                                                    ...
                                                                    <table class="table table-striped">
                                                                        ...
                                                                        $i = 1;                                                                        
                                                                                ...
                                                                                $sql = "SELECT requisition.*, department.*, division.*, user_accounts.*, requisition.status as requisition_status FROM requisition,user_accounts,division,department WHERE requisition.user_id =user_accounts.employee_id AND requisition.division_id=division.division_id AND requisition.department_id = department.department_id  AND requisition.status=1 ORDER BY requisition.id  DESC";
                                ...
                                <!-- ============= Division Head =======                                                             -->
                                                              ...
                                                              <?php 
                                                                    ...
                                                                    <table class="table table-striped table-bordered">
                                                                        ...
                                                                        if ($_SESSION['access_permission'] == "Department Head") {
                                                                            ...
                                                                            $sql = "SELECT * FROM requisition WHERE department_id='$department_id' AND status IN(1,11)";
                                                                        }
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <?php }?>
                                                                                      <?php if ($row['status'] == 11) {?>
                                                                                           <button class="btn-sm btn btn-success"> Forwarded to Department Head </button>
                                                                                    <?php }?>
                                                                                    <?php if ($row['status'] == 2) {?>
                                                                                           <button class="btn-sm btn btn-danger"> Rejected </button>
                                                                                    <?php }?>
                                        ...
                                        <!-- ============= Store Admin =======-->
                                                                    ...
                                                                    <table class="table table-striped table-bordered">
                                                                        ...
                                                                        <?php
                                                                        $i = 1;
                                                                        $sql = "SELECT requisition.*, division.division_name, department.department_name FROM requisition,division,department WHERE requisition.division_id=division.division_id AND requisition.department_id=department.department_id AND requisition.status=3";
                                                                        if ($result=mysqli_query($conn,$sql))
                                                                        {
                                                                          while ($row=mysqli_fetch_assoc($result))
                                                                          {
                                                    ...
                                                    <?php   }
                                                              ...
                                                              <?php 
                                                                    ...
                                                                    <table class="table table-striped table-bordered">
                                                                        ...
                                                                        <?php
                                                                        $i = 1;
                                                                        $sql = "SELECT requisition.*, division.division_name, department.department_name FROM requisition,division,department WHERE requisition.division_id=division.division_id AND requisition.department_id=department.department_id AND requisition.status IN(3,5) ";
                                                                        if ($result=mysqli_query($conn,$sql))
                                                                        {
                                                                          while ($row=mysqli_fetch_assoc($result))
                                                                          {
                                                    ...
                                                    <?php   }
                                                            ...
                                                            ?>                                                                     
                                                                    <table class="table table-striped">
                                                                        ...
                                                                        $i = 1;
                                                                        $user_id = $_SESSION['employee_id'];
                                                                        $sql = "SELECT requisition.*, requisition.status as requisition_status FROM requisition WHERE  user_id='$user_id' AND status=1 ";
                                                                         if ($result=mysqli_query($conn,$sql))
                                                                         {
                                                                          while ($row=mysqli_fetch_assoc($result))
                                                                          {?>
