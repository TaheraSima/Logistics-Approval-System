                ...
                <div class="content-wrapper">
                    <div class="content-header">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h1 class="m-0 text-dark">Rejected Request</h1>
                                </div>
                                <!-- /.col -->
                                <div class="col-sm-6">
                                ...
                                <!-- ============= Division Head =======                                                             -->
                                                    ...
                                                    <?php   }
                                                              ...
                                                              <?php }?> 
                                                               ...
                                                               <!-- ============= Department  Head =======                                                             -->
                                                                 <?php 
                                                                    if ($_SESSION['access_permission'] == ("Department Head" && "Checker")) {
                                                                    ?>                                                                     
                                                                    <table class="table table-striped table-bordered">
                                                                        <tr>
                                                                            <th> SL#</th>
                                        ...
                                        <!-- ============= Store Admin =======-->
                                                                    ...
                                                                    <table class="table table-striped table-bordered">
                                                                        ...
                                                                        $i = 1;
                                                                        $sql = "";
                                                                        // $sql = "SELECT requisition.*, division.division_name, department.department_name FROM requisition,division,department WHERE requisition.division_id=division.division_id AND requisition.department_id=department.department_id AND requisition.status IN(1, 3, 4)";
                                                                        if ($result=mysqli_query($conn,$sql))
                                                                        {
                                                                          while ($row=mysqli_fetch_assoc($result))
                                                                          {?>
