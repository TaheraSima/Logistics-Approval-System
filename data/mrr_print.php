...
<div align="center">
  <table width="80%" border="1" align="center" cellpadding="4" cellspacing="0" style="border-collapse:collapse;">
    ...
    <td align="center" valign="middle" nowrap="nowrap" class="style23"><div align="left"><strong>Purchaser Name :</strong></div></td>
	<?php $sqlmr = "SELECT user_accounts.employee_name , requisition.purchaser_id FROM  user_accounts, requisition  WHERE user_accounts.employee_id = requisition.purchaser_id AND requisition.req_no='$pr_no'";
			$resultMrr = mysqli_query($conn, $sqlmr);
			while ($mrrInfo = mysqli_fetch_assoc($resultMrr)) {
			$purchaser_name = $mrrInfo['employee_name']; ?>
			<td align="center" valign="middle" nowrap="nowrap" class="style23"><div align="left"><strong><?php echo $purchaser_name; ?></strong></div></td>
			<?php }?>
	
  </tr>
  
	<tr>
    <td align="center" valign="middle" nowrap="nowrap" class="style23"><div align="left"><strong>Purchase Accepted By :</strong></div></td>
	<?php $sqllog = "SELECT user_accounts.employee_name , requisition.purchaser_id FROM  user_accounts, requisition  WHERE user_accounts.employee_id = requisition.assigned_by AND requisition.req_no='$pr_no'";
			$log_info = mysqli_query($conn, $sqllog);
			while ($logInfo = mysqli_fetch_assoc($log_info)) {
			$log_name = $logInfo['employee_name']; ?>
			<td align="center" valign="middle" nowrap="nowrap" class="style23"><div align="left"><strong><?php echo $log_name; ?></strong></div></td>
			<?php }?>
    
    <td align="center" valign="middle" nowrap="nowrap" class="style23"><div align="left"><strong>Delivered By : </strong></div></td>
	<?php $sqlstr = "SELECT user_accounts.employee_name , requisition.purchaser_id FROM  user_accounts, requisition  WHERE user_accounts.employee_id = requisition.delivered_by AND requisition.req_no='$pr_no'";
			$resultstr = mysqli_query($conn, $sqlstr);
			while ($strInfo = mysqli_fetch_assoc($resultstr)) {
			$delivered_by = $strInfo['employee_name']; ?>
			<td align="center" valign="middle" nowrap="nowrap" class="style23"><div align="left"><strong><?php echo $delivered_by ;?></strong></div></td>
			<?php }?>
	
  </tr>
  <tr>
    <td align="center" valign="middle" nowrap="nowrap" class="style23"><div align="left"><strong>Requisition Checked By :</strong></div></td>
	<?php $sqllog = "SELECT user_accounts.employee_name , requisition.checker_id FROM  user_accounts, requisition  WHERE user_accounts.employee_id = requisition.checker_id AND requisition.req_no='$pr_no'";
			$log_info = mysqli_query($conn, $sqllog);
			while ($logInfo = mysqli_fetch_assoc($log_info)) {
			$log_name = $logInfo['employee_name']; ?>
			<td align="center" valign="middle" nowrap="nowrap" class="style23"><div align="left"><strong><?php echo $log_name; ?></strong></div></td>
            ...
            <td align="center" valign="middle" nowrap="nowrap" class="style23">&nbsp;</td>
            <?php $sqlstr = "SELECT user_accounts.employee_name , requisition.purchaser_id FROM  user_accounts, requisition  WHERE user_accounts.employee_id = requisition.delivered_by AND requisition.req_no='$pr_no'";
			$resultstr = mysqli_query($conn, $sqlstr);
			while ($strInfo = mysqli_fetch_assoc($resultstr)) {
			$delivered_by = $strInfo['employee_name']; ?>
