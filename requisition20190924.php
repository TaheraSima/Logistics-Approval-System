                ...
                if ( isset($_GET['success']) && $_GET['success'] == 5 ){?>
                                ...
                                <!-- ========== Division Head ===== -->
                                                                    ...
                                                                    <table class="table table-striped table-bordered mydatatable">
                                                                        ...
                                                                        $sqlv = "SELECT * FROM requisition WHERE division_id='$division_id' AND status IN(11,1) ORDER BY id DESC";
                                                              ...
                                                              <!-- ================================checker========================== -->
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    <table class="table table-striped table-bordered mydatatable">
                                                                        ...
                                                                        $i = 1;
                                                                        $division_id = $_SESSION['division_id'];
                                                                        $sql = "SELECT * FROM requisition WHERE division_id = $division_id and status IN(0,11) ORDER BY id DESC";
                                                                        if ($result=mysqli_query($conn,$sql))
                                                                        {
                                                                          while ($row=mysqli_fetch_assoc($result))
                                                                          {
                                                                                            ...
                                                                                            <div class="row">
                                                                                                 <?php if ($row['req_type']== "Project") {?>
                                                                                                   ...
                                                                                                   <?php }
                                                                                                    ...
                                                                                                    <h6><b>Request Type: </b><?php echo $project_name;?> Purpose</h6>
                                                                                                 <?php  }
                                                                                                    ?>
                                                                                            </div>
                                                                                            <!-- form start -->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">                                                            
                                                                ...
                                                                $output = $employee_id.$rand_number."-".++$inc;
                                                                echo $output;
                                                                $_SESSION['inc'] = $inc;
                                ...
                                if (req_type == 'Project') 
                                {
                                    var html = `<br>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                           <select style="width:250px" class="input-group form-control select2" name="project_name" required>
                                                                <option value="" selected>Select One</option>
