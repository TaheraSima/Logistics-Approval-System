                ...
                <div class="content-wrapper">
                    <div class="content-header">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                     <?php  if ($_SESSION['access_permission'] == 'purchaser' || $_SESSION['access_permission'] == 'Store Admin' || $_SESSION['access_permission'] == 'log admin' ) {?>
                                       <h1 class="m-0 text-dark">Purchased Requisition</h1>
                                   <?php }else{?>
                                    <h1 class="m-0 text-dark">Pending Requisition</h1>
                                   <?php }?>
                                </div>
                                <!-- /.col -->
                                <div class="col-sm-6">
                                                                ...
                                                                <div class="card-body p-0">
                                                                    ...
                                                                    <table class="table table-striped">
                                                                        ...
                                                                        $i = 1;                                                                        
                                                                                ...
                                                                                $sql = "SELECT requisition.*, division.*, user_accounts.*, requisition.status as requisition_status FROM requisition,user_accounts,division WHERE requisition.user_id =user_accounts.employee_id AND requisition.division_id=division.division_id AND requisition.status=0 ORDER BY requisition.id  DESC";
                                ...
                                <!-- ============= Division Head =======                                                             -->
                                                    ...
                                                    <?php   }
                                                              ...
                                                              <?php }?> 
                                                               <!-- ============= Department Head =======-->
                                                               <?php 
                                                                    if ($_SESSION['access_permission'] == "Department Head" || $_SESSION['access_permission'] == "Checker") {
                                                                    ?>                                                                     
                                                                    <table class="table table-striped table-bordered">
                                                                        <tr>
                                                                            <th> SL#</th>
                                                                        ...
                                                                        if ($_SESSION['access_permission'] == "Department Head") {
                                                                            ...
                                                                            $sql = "SELECT * FROM requisition WHERE department_id='$department_id' AND status=0";
                                                                        }
                                        ...
                                        <!-- ============= Store Admin =======-->
                                                                    ...
                                                                    <table class="table table-striped table-bordered">
                                                                        ...
                                                                        <?php
                                                                        $i = 1;
                                                                        $sql = "SELECT requisition.*, division.division_name, department.department_name FROM requisition,division,department WHERE requisition.division_id=division.division_id AND requisition.department_id=department.department_id AND requisition.status=8";
                                                                        if ($result=mysqli_query($conn,$sql))
                                                                        {
                                                                          while ($row=mysqli_fetch_assoc($result))
                                                                          {
                                                    ...
                                                    <?php   }
                                                              ...
                                                              <?php 
                                                                    ...
                                                                    <table class="table table-striped table-bordered">
                                                                        ...
                                                                        <?php
                                                                        $i = 1;
                                                                        $sql = "SELECT requisition.*, division.division_name, department.department_name FROM requisition,division,department WHERE requisition.division_id=division.division_id AND requisition.department_id=department.department_id AND requisition.status=1";
                                                                        if ($result=mysqli_query($conn,$sql))
                                                                        {
                                                                          while ($row=mysqli_fetch_assoc($result))
                                                                          {
                                                    ...
                                                    <?php   }
                                                            ...
                                                            ?>                                                                     
                                                                    <table class="table table-striped">
                                                                        ...
                                                                        $i = 1;
                                                                        $user_id = $_SESSION['employee_id'];
                                                                        $sql = "SELECT requisition.*, requisition.status as requisition_status FROM requisition WHERE  user_id='$user_id' AND status IN(0,11)";
                                                                         if ($result=mysqli_query($conn,$sql))
                                                                         {
                                                                          while ($row=mysqli_fetch_assoc($result))
                                                                          {?>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <?php }?>
                                                                                    <?php if ($row['status'] == 11) {?>
                                                                                           <button class="btn-sm btn btn-success"> Forwared to Department Head </button>
                                                                                    <?php }?>
