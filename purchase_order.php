		    ...
		    <?php 
		    	if ( isset($_GET['success']) && $_GET['success'] == 1 ){?>
				    <div class="alert alert-success">
					  <strong>Success!</strong> New Purchase Order
 Added Successfully.
					</div>
		     <?php } ?>
		    <?php 
		    	if ( isset($_GET['success']) && $_GET['success'] == 2 ){?>
				    <div class="alert alert-success">
					  <strong>Success!</strong> Purchase Order
 ...
 Deleted Successfully.
          ...
          <div class="card-body p-0">
            <table class="table table-striped">
              ...
              <!-- start from here now...........start from here now.............start from here now..........-->
              	<?php
              		$i = 1;
              		$sql = "SELECT department.department_id, department.department_name, department.division_id, department.department_status, division.division_name FROM department,division WHERE department.division_id=division.division_id ORDER BY department.department_id DESC";
    ...
    <div class="modal fade" id="division_edit_modal_<?php echo $row["pur_id"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-scrollable" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title"> Edit Purchase Order
</h5>
              ...
              <form role="form" action="data/division.php?update" method="post">
                <div class="card-body">
                  <div class="form-group">
                  	<input type="hidden" name="pur_id" value="<?php echo $row["pur_id"] ?>">
                    <label for="division_name">Purchase Order
 Name</label>
    ...
    <!-- company Type edit moldal -->
    <div class="modal fade" id="division_view_modal_<?php echo $row["pur_id"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-scrollable" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title"> View Purchase Order
</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
...
<!-- company Type edit moldal -->
<div class="modal fade" id="division_delete_modal_<?php echo $row["pur_id"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
<div class="modal-dialog modal-dialog-scrollable" role="document">
<div class="modal-content">
  <div class="modal-body">
      <!-- form start -->
...
<!-- /.card -->
			...
			<div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
			  <div class="modal-dialog modal-dialog-scrollable" role="document">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h5 class="modal-title" id="exampleModalScrollableTitle">Create New Purchase Order
</h5>
			        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			          <span aria-hidden="true">&times;</span>
			        </button>
		              ...
		              <form role="form" action="data/division.php?store" method="post">
		                <div class="card-body">
		                  <div class="form-group">
		                    <label for="division_name">Purchase Order
 Name</label>
		             <input type="text" class="form-control" name="division_name"  placeholder="Enter Purchase Order" required>
		                  </div>
